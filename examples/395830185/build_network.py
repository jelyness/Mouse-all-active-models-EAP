...
net.add_nodes(N=1,  # specifiy the number of cells belong to said group.
              pop_name='Scnn1a', location='L4', ei='e',  # pop_name, location, and ei are optional parameters that help's identifies properties of the cells. The modeler can choose whatever key-value pairs as they deem appropiate.
	      ...
	      rotation_angle_xaxis=0,#-0.188855,
              rotation_angle_yaxis=0,
              rotation_angle_zaxis=0,#2.485676
#Note that the y-axis rotation is differnt for each cell (ie. given a list of size N), but with z-axis rotation all cells have the same value
              ...
              model_processing='aibs_allactive_directed',  # further instructions for how to processes a cell model. In this case aibs_perisomatic is a built-in directive to cut the axon in a specific way
              dynamics_params='395830185_aa_fit.json',  # Name of file (downloaded from Allen Cell-Types) used to set model parameters and channels
              morphology='395830185_upright.swc'),  # Name of morphology file downloaded
